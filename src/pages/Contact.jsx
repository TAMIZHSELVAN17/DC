...
const ContactDetails = () => {
  return (
    <div className="bg-white py-12 px-6 text-center rounded-lg shadow-md">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
        ...
        <div className="flex flex-col items-center text-center">
          ...
          <p className="text-gray-600 text-sm mt-1 px-4">
            No.34B, GPH Road, Katpadi, Vellore, Tamil Nadu – 632001, India
          </p>
        </div>
        ...
        <div className="flex flex-col items-center text-center">
          ...
          <p className="text-gray-600 text-sm mt-1">+91 98653 98653</p>
        </div>
        ...
        <div className="flex flex-col items-center text-center">
          ...
          <p className="text-gray-600 text-sm mt-1">support@dasscomputer.in</p>
        </div>
      </div>
    </div>
  );
  ...
  return (
    <div className="bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-10">
        ...
        {/* Google Map */}
        <div className="w-full h-[450px] rounded-lg shadow overflow-hidden md:col-span-2">
          <iframe
